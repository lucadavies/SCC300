...
The following section covers the various experimentation and analysis carried out using Sentiplot as a tool for Sentiment Analysis and graphing accordingly.
    ...
    \subsection{Curve Identification}
        ...
        \subsubsection{Whole Text Analysis}
            ...
            \end{figure}
            A number of Shakespeare plays were also processed in an initial attempt to match one of Vonnegut's suggestions in his lecture via the `curve' (supposedly a flat line) produced for Hamlet. Although there were some minor exceptions, the majority of these texts produced higly restircted and unvarying graphs
            \begin{figure}
